//
//  ModalEjecutarViewController.swift
//  Sigmo
//
//  Created by macOS User on 16/02/18.
//  Copyright © 2018 Sgonzalez. All rights reserved.
//

import UIKit

class ModalEjecutarViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        print("ACC_CAPACITACION = ", acc_capacitacion!)
        print("EN PROCESO = ", ep!)
    ...
    @IBAction func postergar(_ sender: Any) {
        ...
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "postergar"), object: nil)
    ...
    @IBAction func realizarBtn(_ sender: Any) {
        ...
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "ejecutar"), object: nil)
        self.navigationController?.popToRootViewController(animated: true)
        dismiss(animated: true)
    }
    ...
    @IBAction func capacitacionUrl(_ sender: Any) {
        ...
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "capacitacion"), object: nil)
        self.navigationController?.popToRootViewController(animated: true)
        dismiss(animated: true)
    }
    ...
    @IBAction func verEnproceso(_ sender: Any) {
        ...
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "verEnproceso"), object: nil)
        self.navigationController?.popToRootViewController(animated: true)
        dismiss(animated: true)
    }
