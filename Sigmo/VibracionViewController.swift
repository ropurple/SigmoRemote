...
@available(iOS 11.0, *)
class VibracionViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBOutlet weak var vibAxialField: UITextField!
    @IBOutlet weak var vibVertField: UITextField!
    @IBOutlet weak var vibHorField: UITextField!
    ...
    struct Ejecucion: Codable {
        ...
        var mol_axial: String
        var mol_horizontal: String
        var mol_vertical: String
    ...
    func parsearDatos() -> String{
        ...
        let datos = Ejecucion(act_latitud: lat, act_longitud: lon, act_radio: "0", mol_axial: vibAxialField.text!, mol_horizontal: vibHorField.text!, mol_vertical: vibVertField.text!)
