//
//  MolinoViewController.swift
//  Sigmo
//
//  Created by macOS User on 28/03/18.
...
@available(iOS 11.0, *)
class MolinoViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBOutlet weak var tambField: UITextField!
    @IBOutlet weak var tlubField: UITextField!
    @IBOutlet weak var tfajaField: UITextField!
    @IBOutlet weak var tAField: UITextField!
    @IBOutlet weak var tBField: UITextField!
    @IBOutlet weak var tCField: UITextField!
    @IBOutlet weak var tDField: UITextField!
    @IBOutlet weak var tEField: UITextField!
    @IBOutlet weak var tFField: UITextField!
    @IBOutlet weak var tGField: UITextField!
    @IBOutlet weak var tHField: UITextField!
    @IBOutlet weak var tIField: UITextField!
    ...
    func ejecutarActividad(id_actividadestado: Int64){
        ...
        if(id_actividadestado == 2){
            updateActividadServer(id_actividad: id_actividad, id_producto: 0, act_cantidad: 0, act_obs_ejecutor: self.observacionField.text!, id_tipoobservacion: self.id_tipoobservacion, id_usuario: userID!, id_actividadestado: 2, act_fec_realizada: fecha, act_datos: datos, id_nivel: Int64(id_nivel), id_objeto: Int64(datosEjecucion.id_objeto!)!, success: { success, state, message, id_actEnproceso in
                if(success && state == 1){
    ...
    struct Ejecucion: Codable {
        ...
        var mol_tambiente: String
        var mol_tfaja: String
        var mol_tlubricante: String
        var mol_a: String
        var mol_b: String
        var mol_c: String
        var mol_d: String
    ...
    func parsearDatos() -> String{
        ...
        let datos = Ejecucion(act_latitud: lat, act_longitud: lon, act_radio: "0", mol_tambiente: tambField.text!, mol_tfaja: tfajaField.text!, mol_tlubricante: tlubField.text!, mol_a: tAField.text!, mol_b: tBField.text!, mol_c: tCField.text!, mol_d: tDField.text!, mol_e: tEField.text!, mol_f: tFField.text!, mol_g: tGField.text!, mol_h: tHField.text!, mol_i: tIField.text!)
